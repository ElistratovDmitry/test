...
при возникновении конфликта, необходимо: разрешить конфликт, удалить ненужные ветки. 

[comment] Разрешил конфликт и удалид тексты для конфликтао

![какое то фото](DSC02049.jpg)
